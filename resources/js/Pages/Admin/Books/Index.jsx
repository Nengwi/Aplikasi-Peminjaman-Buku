...
import { Plus, Edit, Trash2, Book as BookIcon, Search } from 'lucide-react';
                                        ...
                                        <tr key={book.id} className="hover:bg-white/10 transition-all group">
                                            ...
                                            <td className="p-8 text-right">
                                                <div className="flex justify-end gap-3">
                                                    <button className="p-3 bg-amber-500/10 text-amber-500 rounded-xl hover:bg-amber-500 hover:text-white transition-all shadow-lg hover:shadow-amber-500/20">
                                                        <Edit size={20} />
                                                    </button>
                                                    <button className="p-3 bg-red-500/10 text-red-500 rounded-xl hover:bg-red-500 hover:text-white transition-all shadow-lg hover:shadow-red-500/20">
                                                        <Trash2 size={20} />
                                                    </button>
                                                </div>
                                            </td>
